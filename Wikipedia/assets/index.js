...
const collectionUtilities = require('wikimedia-page-library').CollectionUtilities
...
class ClickedItem {
   ...
   */
  type() {
    if (collectionUtilities.isCitation(this.href)) {
...
const sendMessageForReferenceWithTarget = target => {
  const nearbyReferences = collectionUtilities.collectNearbyReferences( document, target )
